...
//=====================================================================================constructor methods
__h__ PottsJitAnnealable::PottsJitAnnealable(PyObject* task, bool USE_GPU){
	...
	if (USE_GPU) dispatch = GpuPottsJitDispatch;
    else         dispatch = CpuPottsJitDispatch;
}

__h__ __d__ float PottsJitAnnealable::EnergyOfState(int* state){
	float e = 0;
...
__h__ __d__ void PottsJitAnnealable::FinishEpoch(){
	// float eps = 1e-5;
...
__h__ __d__ float PottsJitAnnealable::GetActionDE(int action_num){
...
__h__ __d__ void PottsJitAnnealable::TakeAction_toc(int action_num){
