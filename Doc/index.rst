...
PottsPlayground is for constructing and simulating combinatorial optimization problems represented as a Potts Model.  It includes a system for constructing weight matrices in Python and C++/CUDA extensions for minimizing the Potts model energy on a CPU or GPU using various flavors of Gibbs sampling.
